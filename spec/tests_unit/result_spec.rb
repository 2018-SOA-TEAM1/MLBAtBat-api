...
describe 'Unit test of Result value' do
  it 'should valid success status and message' do
    result = MLBAtBat::Value::Result.new(status: :ok, message: 'foo')
  ...
  it 'should valid failure status and message' do
    result = MLBAtBat::Value::Result.new(status: :not_found, message: 'foo')
  ...
  it 'should report error for invalid status' do
    proc do
      MLBAtBat::Value::Result.new(status: :foobar, message: 'foo')
